...
class IDTLZ(Problem):
    ...
    def evaluate(self, x):
        ...
        self.lib.libIDTLZ(n_sample, self.n_var, self.n_obj, self.testcase, data_in, data_out)
    ...
    def _lib_setup(self):
        self.lib = ctypes.CDLL(glob.glob('problems/clib/libIDTLZ.so')[0])
        self.lib.libIDTLZ.argtypes = [ctypes.c_int,
                                    ctypes.c_int,
                                    ctypes.c_int,
                                    ctypes.c_int,
        ...
        self.lib.libIDTLZ.restype = ctypes.c_int
